...
class FnSym extends Sym {
    ...
    public void setSizeOfLocals(int num) {
    	this.sizeOfLocals = num;
    }
    
    public void setSizeOfParams(int num) {
    	this.sizeOfParams = num;
    }
    ...
    public String toString() {
        ...
        str += ", params_size: " + sizeOfParams + ", locals_size: " + sizeOfLocals;
        return str;
    }
}
